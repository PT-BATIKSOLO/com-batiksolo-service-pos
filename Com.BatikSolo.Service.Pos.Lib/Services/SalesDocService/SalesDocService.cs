...
using Com.BatikSolo.Service.Pos.Lib.Services.SalesDocService;
...
namespace Com.BatikSolo.Service.Pos.Lib.Services.SalesDocService
{
    public class SalesDocService : ISalesDocService
    {
        ...
        */
        ...
        public IQueryable<SalesReportViewModel> GetSalesAllQuery(string storageId, DateTime dateFrom, DateTime dateTo)
        {
            ...
            SqlConnection conn = new SqlConnection("Server=batiksolo-db-server.database.windows.net,1433;Database=batiksolo-db-pos;User=batiksoloprd;password=batiksolo123.;Trusted_Connection=False;Encrypt=True;MultipleActiveResultSets=true");
            ...
            SqlConnection connCore = new SqlConnection("Server=batiksolo-db-server.database.windows.net,1433;Database=batiksolo-db-core;User=batiksoloprd;password=batiksolo123.;Trusted_Connection=False;Encrypt=True;MultipleActiveResultSets=true");
