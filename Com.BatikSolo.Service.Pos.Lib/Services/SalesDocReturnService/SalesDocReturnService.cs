...
using Com.BatikSolo.Service.Pos.Lib.Models.SalesReturn;
...
using Com.BatikSolo.Service.Pos.Lib.ViewModels.SalesDocReturn;
using Com.BatikSolo.Service.Pos.Lib.Models.SalesDoc;
using Com.BatikSolo.Service.Pos.Lib.ViewModels.SalesDoc;
using System.Threading.Tasks;
using Com.Moonlay.Models;
using Com.BatikSolo.Service.Pos.Lib.ViewModels.NewIntegrationViewModel;
using Com.BatikSolo.Service.Pos.Lib.Interfaces;
using System.Net.Http;
using MongoDB.Bson;
using HashidsNet; 

namespace Com.BatikSolo.Service.Pos.Lib.Services.SalesDocReturnService
{
    public class SalesDocReturnService : ISalesDocReturnService
    {
        ...
        public SalesDocReturnViewModel MapToViewModel(SalesDocReturn model)
        {
            ...
            foreach (SalesDocDetail i in sales.Details)
            {
                    ...
                    salesDocDetailViewModel.item = new BatikSolo.Service.Pos.Lib.ViewModels.NewIntegrationViewModel.ItemViewModel
                    {
            ...
            viewModel.sales = new BatikSolo.Service.Pos.Lib.ViewModels.SalesDoc.SalesDocViewModel
            {
                Active = sales.Active,
                date = sales.Date,
            ...
            foreach (SalesDocDetail i in salesreturn.Details)
            {
                ...
                if (i.isReturn)
                {
                    ...
                    foreach (var retur in a)
                    {
                        ...
                        salesDocDetailreturnitemViewModel.item = new BatikSolo.Service.Pos.Lib.ViewModels.NewIntegrationViewModel.ItemViewModel
                        {
            ...
            foreach(var i in model.Details)
            {
                ...
                salesDocDetailViewModel.item = new SalesDocDetailViewModel
                {
                    ...
                    total = i.Total,
                    item = new BatikSolo.Service.Pos.Lib.ViewModels.NewIntegrationViewModel.ItemViewModel
                    {
                        ArticleRealizationOrder = i.ItemArticleRealizationOrder,
                        code = i.ItemCode,
                        DomesticCOGS = i.ItemDomesticCOGS,
                ...
                foreach(var d in salesreturn.Details)
                {
                    ...
                    salesDocDetailreturnViewModel.item = new BatikSolo.Service.Pos.Lib.ViewModels.NewIntegrationViewModel.ItemViewModel
                    {
