...
using Com.BatikSolo.Service.Pos.Lib.Models.Discount;
...
using MongoDB.Bson;
using HashidsNet;
using Com.BatikSolo.Service.Pos.Lib.ViewModels.Discount;
using Com.Danliris.Service.Inventory.Lib.Helpers;
using static Com.BatikSolo.Service.Pos.Lib.ViewModels.Discount.DiscountViewModel;
...
namespace Com.BatikSolo.Service.Pos.Lib.Services.DiscountService
{
